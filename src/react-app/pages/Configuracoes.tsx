    ...
    <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 lg:py-6 max-w-7xl mx-auto">
      ...
      <div className="mt-8 pt-4 border-t border-gray-200 text-center">
        <p className="text-xs text-gray-400">
          Versão do Sistema: <span className="font-mono font-medium text-gray-500">1.1.26</span> <span className="text-emerald-500">(ONNX OCR + Fast-Track MonitoringContext)</span>
        </p>
      </div>
    </div>
  );
