...
import MonitoramentoLocal from '@/react-app/pages/MonitoramentoLocal';
import Configuracoes from '@/react-app/pages/Configuracoes';
import GuiaRekorScout from '@/react-app/pages/GuiaRekorScout';
              ...
              <div className="min-h-screen bg-gray-50">
                ...
                <main className="pt-[56px] sm:pt-[60px] lg:pt-[112px] pb-4 sm:pb-6">
                  <Routes>
                    ...
                    <Route path="/monitoramento-local" element={<MonitoramentoLocal />} />
                    <Route path="/configuracoes" element={<Configuracoes />} />
                    <Route path="/guia-rekor-scout" element={<GuiaRekorScout />} />
                  </Routes>
                </main>
              </div>
            </PrivateRoute>
