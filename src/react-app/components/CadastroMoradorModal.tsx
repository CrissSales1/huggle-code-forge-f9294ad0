...
export default function CadastroMoradorModal({ isOpen, onClose, onSuccess }: CadastroMoradorModalProps) {
      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md">
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <div className="flex items-center space-x-2">
            ...
            <h2 className="text-lg font-semibold text-gray-900">Cadastrar Veículo de Morador</h2>
          </div>
          <button
            onClick={onClose}
